...
ALLOWED_HOSTS = ['protected-visions-ezlb3.ondigitalocean.app', 'protected-visions-tnr9u.ondigitalocean.app']
...
# ML Model Settings
ML_MODELS = {
    'YOLO_WEIGHTS_PATH': os.path.join(BASE_DIR, 'detection', 'models', 'yolo_weights.pt'),
